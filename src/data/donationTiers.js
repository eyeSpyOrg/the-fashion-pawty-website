...
export const levels = [
  {
    ...
    bullets: [
      ...
      'A guide dog gives someone their independence back — and the confidence to go anywhere',
    ],
    ctaDonate: 'Give $20',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Helps open doors to employment and opportunities for people in the blind and low vision community',
    ],
    ctaDonate: 'Give $90',
    ctaPawtners: 'Join for $90',
    image: '/images/donations/navigator-support.webp',
    imageAlt: 'A person walking alongside a guide dog',
    stripeUrl: 'https://donate.stripe.com/fZu8wO91m9ZD6tt0QKejK0j',
  },
  {
    ...
    bullets: [
      ...
      'Helps grow a community that shows up and supports each other',
    ],
